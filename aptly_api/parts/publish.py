...
class PublishAPISection(BaseAPIClient):
    @staticmethod
    def endpoint_from_response(
        api_response: Union[Dict[str, str], Dict[str, List[str]], Dict[str, List[Dict[str, str]]]],
    ) -> PublishEndpoint:
    ...
    def publish(
        ...
        *,
        ...
        sign_keyring: Optional[str] = None,
        sign_secret_keyring: Optional[str] = None,
    ...
    def update(
        ...
        *,
        prefix: str,
        distribution: str,
        snapshots: Optional[Sequence[Dict[str, str]]] = None,
        force_overwrite: bool = False,
        sign_skip: bool = False,
        sign_batch: bool = True,
        sign_gpgkey: Optional[str] = None,
        ...
        .. code-block:: python
            p.update(
                prefix="s3:maurusnet:nightly/stretch",
